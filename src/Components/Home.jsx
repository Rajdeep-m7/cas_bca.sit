    ...
    <div id="Home">
        <div className='w-full bg-blue-900 p-10'>
            ...
            <div className='flex gap-5 mb-15 flex-col md:flex-row'>
                <button onClick={handleClick} className='font-bold bg-amber-400 rounded-lg md:p-4 py-4 px-15 border hover:bg-amber-500 cursor-pointer'>Join Society</button>
                <button className='border bg-transparent text-white md:px-5.5 py-4 px-15 rounded-lg hover:bg-white cursor-pointer hover:text-blue-900 transition-color duration-500'><a href="#Events">Explore Events</a></button>
            </div>
            </div>
        </div>
    </div>
